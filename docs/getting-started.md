...
- [Variables](variables.md) -- learn about `let`, `var`, and `const`
- [Functions](functions.md) -- parameters, return types, and calling
- [Strings](strings.md) -- interpolation and raw strings
