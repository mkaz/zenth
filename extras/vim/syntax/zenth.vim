...
" Built-in functions
syn keyword zenthBuiltin      print println len str hashmap filter append push pop file flag abs min max clamp round floor ceil pow sqrt to_base assert assert_eq reduce join zip extend repeat
