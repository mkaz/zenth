...
See [Strings]({{< relref "strings" >}}) for interpolation and raw string details.
...
See [Dates]({{< relref "dates" >}}) for full documentation.
...
See [Arrays]({{< relref "arrays" >}}) for more details.
...
See [Tuples]({{< relref "tuples" >}}) for named tuples, destructuring, and usage in functions.
...
See [Objects]({{< relref "objects" >}}) for methods and `self`.
...
See [Functions]({{< relref "functions#function-types" >}}) for examples of higher-order functions and passing functions as values.
...
See [Enums]({{< relref "enums" >}}) for explicit values, comparison, and match usage.
